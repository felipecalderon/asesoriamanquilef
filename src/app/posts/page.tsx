    ...
    <div className="pt-3 mx-auto max-w-4xl">
      <Accordion 
        ...
        <AccordionItem key="2"
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 justify-items-center mt-6 gap-2 md:gap-4">
            {
              posts.map(post => (
                <Card key={post.id} className="py-2 w-fit max-w-xs bg-secundarioClaro min-h-[300px]" isPressable onPress={() => redirectToPost(post.id)}>
