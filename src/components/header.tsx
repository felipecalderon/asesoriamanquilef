                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                        <ul className="flex flex-col font-medium p-4 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 dark:border-gray-700">
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-violet-600 bg-opacity-60 hover:bg-opacity-100 hover:scale-105 rounded transition-all" aria-current="page">Inicio</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-violet-600 bg-opacity-60 hover:bg-opacity-100 hover:scale-105 rounded transition-all">Servicios</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-violet-600 bg-opacity-60 hover:bg-opacity-100 hover:scale-105 rounded transition-all">Informaciones</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-violet-600 bg-opacity-60 hover:bg-opacity-100 hover:scale-105 rounded transition-all">Contacto</a>
                            </li>
                        </ul>
                    </div>
                </div>
