                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex items-center md:order-2 space-x-2 md:space-x-0 rtl:space-x-reverse">
                        <button type="button" className="flex text-sm rounded-full md:me-0 focus:ring-2 focus:ring-violet-900 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                            ...
                            <BiSolidUserCircle className="text-4xl md:text-5xl text-violet-900 hover:text-violet-700" />
                        </button>
                        ...
                        <button data-collapse-toggle="navbar-user" type="button" className="inline-flex items-center p-2 justify-center text-sm bg-violet-100 text-violet-900 rounded-lg md:hidden hover:bg-violet-50 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-user" aria-expanded="false">
                            <span className="sr-only">Abrir menú</span>
                            <BiMenuAltRight className='text-2xl md:text-5xl'/>
                        </button>
                    </div>
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                        <ul className="flex flex-col font-medium p-4 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 dark:border-gray-700">
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-violet-600 backdrop:blur-md bg-opacity-60 hover:bg-opacity-100 hover:scale-105 rounded transition-all" aria-current="page">Inicio</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-violet-600 backdrop:blur-md bg-opacity-60 hover:bg-opacity-100 hover:scale-105 rounded transition-all">Servicios</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-violet-600 backdrop:blur-md bg-opacity-60 hover:bg-opacity-100 hover:scale-105 rounded transition-all">Informaciones</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-violet-600 backdrop:blur-md bg-opacity-60 hover:bg-opacity-100 hover:scale-105 rounded transition-all">Contacto</a>
                            </li>
                        </ul>
                    </div>
                </div>
